...
I pannelli di azienda e polizia sono in `pannelli/` (`http://localhost:8787/pannelli/`): ogni ruolo ha le sue dodici parole (le mostra il pannello) e un PIN; la banca registra l'azienda con chiave e coordinate lette dalla sezione Chiavi. L'elenco dei dipendenti sta nel browser dell'azienda e si esporta a quello della polizia; nel registro non entra mai.
